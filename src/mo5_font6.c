...
static unsigned char f_PLUS[]     = {0x00,0x18,0x7E,0x18,0x00,0x00};
static unsigned char f_AT[]       = {0x3C,0x42,0x5A,0x5E,0x40,0x3C};
static unsigned char f_QUOTE[]    = {0x18,0x18,0x00,0x00,0x00,0x00};
                          ...
                          char c, unsigned char fg_color)
{
    ...
    mo5_clear_sprite_form(tx, ty, 1, 6);
